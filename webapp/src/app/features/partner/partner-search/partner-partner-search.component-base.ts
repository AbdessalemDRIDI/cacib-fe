...
import { PartnerPartnerSearchService } from './services/partner-partner-search.service';

export const COMPONENT_PROVIDERS = [PartnerPartnerSearchService];
...
@Component({
  template: '',
  selector: 'app-partner-partner-search-base',
})
export class PartnerPartnerSearchBaseComponent extends CollectionScreenComponent implements OnInit {
  /**
   * Injected Services
   **/
  screenService = inject(PartnerPartnerSearchService);
   ...
   */
  rowsSelected$: Observable<PartnerModel[]>;
  /**
  ...
  allLazilySelectedRows: PartnerModel[] = [];
  /**
  ...
  ngOnInit() {
    ...
    this.prefix = `${environment.prefix}_partner_partner-search`;
  ...
  getDefaultTitle() {
    return $localize`:@@UID__title;partner;partner-search:List of Partners`;
  }
}
