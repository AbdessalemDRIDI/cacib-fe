...
import { PartnerPartnerSearchInputService } from './services/partner-partner-search-input.service';

export const COMPONENT_PROVIDERS = [PartnerPartnerSearchInputService];
...
@Component({
  template: '',
  selector: 'app-partner-partner-search-input-base',
})
export class PartnerPartnerSearchInputBaseComponent extends ScreenComponent implements OnInit {
  /**
   ...
   * Injected Services
   **/
  screenService = inject(PartnerPartnerSearchInputService);
  ...
  /**
   * Creates a form group for the PartnerSearchInput component.
