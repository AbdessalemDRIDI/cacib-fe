...
/**
 * MessageMessageSearchInputBaseService
 *
 * This service extends the ScreenService and provides functionality
 * for managing data related to the 'Message-MessageSearchInput' screen.
 */
export class MessageMessageSearchInputBaseService extends ScreenService {
  ...
  constructor() {
    super();
    this.screenId = 'Message-MessageSearchInput';
  ...
  openTargetScreen(payload: Payload) {
    ...
    const componentImport = import(
      `@features/message/message-search/message-message-search.component`
    );
