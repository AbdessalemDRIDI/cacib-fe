...
/**
 * MessageMessageEditBaseService
 *
 * This service extends the ScreenService and provides functionality
 * for managing data related to the 'Message-MessageEdit' screen.
 */
export class MessageMessageEditBaseService extends ScreenService {
  constructor() {
    super();
    this.screenId = 'Message-MessageEdit';
  ...
  initValueService(payload: Payload) {
    ...
    if (payload.code === undefined) {
      const params = {};
      return this.httpClient.get<any>(`${this.BASE_PATH}/messages/new`, { params });
    } else {
      const params = {};
      ...
      return this.httpClient.get<any>(`${this.BASE_PATH}/messages/${code}`, { params });
    }
  }
  /**
  ...
  executeSave(context): Observable<any> {
    const params = {};
    return this.httpClient.post<any>(`${this.BASE_PATH}/messages/save`, context.data, { params });
  }
  /**
   * This method displays messages
   * @param params
